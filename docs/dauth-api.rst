...
リクエスト・レスポンスともに、すべてのデータの ``Content-Type`` は ``application/json`` とする。

また、すべてのタイムスタンプは UNIX time 形式で表現される。
...
なお、すべてのエラーレスポンスの body は以下の形式で表現される。
...
* :ref:`post-identity`
* :ref:`get-identity`
* :ref:`get-identity-keys`
* :ref:`get-identity-assets`
* :ref:`post-identity-transaction`
* :ref:`get-transaction`
